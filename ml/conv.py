# -*- coding: utf-8 -*-
"""
Created on Sun Apr 12 11:59:32 2020
...
def main(TEST_NAME, output_file):
    ...
    model = Sequential()
    model.add(Conv1D(64, 3, input_shape=(train.shape[1], look_back), padding='causal'))
    model.add(Flatten())
    model.add(Dense(1))
    ...
    history = model.fit(trainX, trainY, 
                        ...
                        epochs=200, batch_size=20, verbose=2, callbacks=[es])
